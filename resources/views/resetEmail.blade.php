                ...
                {{-- <div id="radius-shape-1" class="position-absolute rounded-circle shadow-5-strong"></div>
                    ...
                    <div class="card bg-glass rounded-0">
                        <div class="card-body px-4 py-5 px-md-5 rounded-0">
                            ...
                            <p class="text-black-50 mb-5"> MASUKAN EMAIL AKUN ANDA</p>
                            <form class="row g-3" method="POST" action="/reset/link">
                                @csrf
                                <div class="form-outline mb-4">
                                    <label for="nama" class="form-label">EMAIL</label>
                                    <input type="text" name="email" id="nama" class="form-control rounded-0 @error('email') is-invalid @enderror" placeholder="Masukan email akun">
                                </div>
                                <!-- Submit button -->
