                ...
                {{-- <div id="radius-shape-1" class="position-absolute rounded-circle shadow-5-strong"></div>
                    ...
                    <div class="card bg-glass rounded-0">
                        <div class="card-body px-4 py-5 px-md-5 rounded-0">
                            ...
                            <div class="row">
                                <div class="col">
                                    <a class="btn btn-danger w-100 rounded-0 text-uppercase" href="/reglevel/{{ Crypt::encrypt('Klien') }}" role="button">Klien</a>
                                </div>
                                <div class="col">
                                    <a class="btn btn-secondary w-100 rounded-0 text-uppercase" href="/reglevel/{{ Crypt::encrypt('Freelancer') }}" role="button">Pekerja lepas</a>
                                </div>
                            </div>
